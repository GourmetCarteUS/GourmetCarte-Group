    ...
    <view class="zp-l-container" :style="[c.customStyle]" @click="doClick">
        <template v-if="!c.hideContent">
            ...
            <image
                ...
                :class="{ 'zp-l-line-loading-custom-image': true, 'zp-l-line-loading-custom-image-animated': c.loadingAnimated }"
            />
            <image
            ...
            <text
                ...
                :style="[{ borderColor: zTheme.circleBorder[ts], borderTopColor: zTheme.circleBorderTop[ts] }, c.iconCustomStyle]"
            />
