<template>
  <Layout>
    ...
    <view class="mt-30 m-30 bg-white b-rd-50">
    ...
    <view class="fixed bottom-0 w-full pb-20">
      <view class="center text-green text-24 mb-10 p-10"
            style="border-bottom: 1rpx solid #e8e8e8;border-top: 1rpx solid #e8e8e8">
        <label>
          <checkbox value="cb" checked="true"/>
          由于本活动特殊性,勾选后授权主理人查看手机号
        </label>
      </view>
      <button class="text-primary font-900 bg-black m-20 b-rd-50 text-32 p-10">确认支付 ${{ totalPrice }}</button>
    </view>
  </Layout>
</template>
