    ...
    <Layout>
        ...
        <view class="m-40 mb-160">
            ...
            <view class="bg-white p-40 b-rd-50">
                    ...
                    <view class="user-lists mt-20 grid grid-cols-5">
                        <view class="user center flex-col" v-for="i in 5">
                            <view class="avatar w-100 h-100 mb-10">
                                <image src="https://img.js.design/assets/img/641803bc0d016e025e84c54a.png" class="h-full w-full b-rd-50" mode="aspectFill" />
                            </view>
                ...
                <view class="text-26 font-400">
                    1. 请在「艺术展览类活动」、「学习课程类活动」场景中二选一，设计活动报名小程序，需包含 4个必选命题 + 1 个可选「TDesign 移动端组件库」 <br />
        ...
        <view class="flex center w-full justify-between bg-primary fixed bottom-0 p-40 pt-30 pb-50" style="box-sizing: border-box">
            ...
            <template v-if="status === 1">
                <view class="bg-black text-white b-rd-50 p-20 flex-1 ml-30 center" @click="onGoPage({ name: 'post-create', params: { id: '1' } }, false)">
                    <text class="text-30 font-900">编辑</text>
                </view>
                <view class="bg-black text-white b-rd-50 p-20 flex-1 ml-30 center" @click="onGoPage({ name: 'order-user', params: { id: '1' } }, false)">
                    <text class="text-30 font-900">检票</text>
                </view>
            </template>
            <template v-else-if="status === 2">
                <view class="bg-black text-white b-rd-50 p-20 flex-1 ml-30 center" @click="onGoPage({ name: 'order-success', params: { id: '1' } }, false)">
                    <text class="text-30 font-900">票据</text>
                </view>
                <view class="bg-black text-white b-rd-50 p-20 flex-1 ml-30 center" @click="onGoPage({ name: 'order-create', params: { id: '1' } }, false)">
