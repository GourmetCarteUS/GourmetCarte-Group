    ...
    <Layout>
        ...
        <z-paging ref="pagingRef" @query="queryList" safe-area-inset-bottom use-safe-area-placeholder :show-scrollbar="false" v-model="dataList" @scroll="onScroll">
            ...
            <view class="m-25 p-35 pb-0 b-rd-20 bg-white">
                ...
                <view class="mt-30">
                    <view class="group-item b-rd-20 p-20 mb-20" v-for="i in 10" @click="onGoPage({ name: 'post-detail', params: { id: i.toString() } }, false)">
                        <view class="flex mb-10">
                            <view class="w-150 h-170 b-rd-20">
                                <image src="https://img.js.design/assets/img/641803bc0d016e025e84c54a.png" class="h-full w-full b-rd-20" mode="aspectFill" />
                            </view>
