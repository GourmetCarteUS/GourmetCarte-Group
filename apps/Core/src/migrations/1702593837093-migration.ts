...
export class Migration1702593837093 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`avatarUrl\` varchar(255) NULL, \`displayName\` varchar(255) NULL, \`openId\` varchar(255) NULL, \`unionId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
